...
## Team Members
  ...
  * Chris Ross - I helped with the front end design of the application. I also kept track of all documents and their needed updates as well as taking the notes for our meetings and adding them to the Project Management Document. I set up the framework for all of the documents, and I did 8 of the test cases in the STD. I also added things where need in the SRS and the SDD.
